...
<section class="promo-hero">
    <div class="container text-center">
        <h1 class="fade-in">Semua Promo</h1>
        <p class="fade-in">Explore amazing deals and special offers</p>
    </div>
</section>
...
<section class="container pb-5">
    ...
    <div class="stats-bar fade-in">
        ...
        <span class="stats-number">{{ $promos->count() }}</span>
        <span class="stats-text">Promos Available</span>
    </div>
    ...
    <div class="promo-grid">
        @foreach ($promos as $p)
            ...
            <div class="promo-card fade-in" data-status="{{ $status }}">
                ...
                <div class="promo-card-body">
                    ...
                    <button class="btn btn-primary w-100 mt-3" 
                            onclick="openPromoDetail({{ $p->id_promo }}, '{{ $statusText }}', '{{ $start->locale('id')->isoFormat('D MMMM YYYY, HH:mm') }}', '{{ $end->locale('id')->isoFormat('D MMMM YYYY, HH:mm') }}', '{{ addslashes($p->deskripsi) }}', '{{ asset('storage/'.$p->gambar) }}')"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detailCardLabel">
                    <i class="bi bi-tags-fill me-2"></i>Detail Promo
                </h5>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function startCountdown(elementId, startStr, endStr) {
        ...
        function update() {
            ...
            // ENDED
            el.innerHTML = `<span style="font-weight: 700;">Promo Berakhir</span>`;
    ...
    window.openPromoDetail = function(name, status, startFormatted, endFormatted, description, imageUrl) {
        ...
        document.getElementById("promoDetailContent").innerHTML = html;
